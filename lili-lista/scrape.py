...
Usage:
    uv run python raw/projects/amazon-affiliate/lili-lista/scrape.py

Output:
    raw/projects/amazon-affiliate/lili-lista/items.json  — raw data
    raw/projects/amazon-affiliate/lili-lista/data.js     — embeddable JS for index.html
"""
